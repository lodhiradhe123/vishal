        ...
        >
          <Card className="rounded-2xl shadow-lg">
            <CardContent className="p-6">
              ...
              <p className="text-base text-gray-700">
                सुनिए रचनाएँ: शायरी, कविताएँ और कहानियाँ आमंत्रित रचनाकारों
                द्वारा प्रस्तुत।
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-2xl shadow-lg">
            <CardContent className="p-6">
              ...
              <p className="text-base text-gray-700 mb-2">
                अगर आप भी अपनी आवाज़ को काग़ज़ पर उतारना चाहते हैं, तो हमें
                भेजिए अपनी रचनाएँ।
              </p>
              <Input placeholder="आपका नाम" className="mb-2" />
              <Textarea placeholder="रचना यहाँ लिखें..." className="mb-2" />
